...
/* ============================================================
   CHAT
   ============================================================ */
/* The tail grows OUT of the bubble's bottom edge: its outer edge leaves the side
   wall, dips past the bottom line, and the tip curls back up into the bubble's
   underside. Box geometry (13 x 21, left/right -9px, bottom -5px):
     x = 9  -> the bubble's side wall      x = 13 -> 4px inside the bubble
     y = 16 -> the bubble's bottom line    y > 16 -> hanging below it
   The caller flattens that bottom corner so the two fills meet along a straight
   run instead of across a rounded gap. */
function tailSvg(dir,col){
  const p = dir==='you'
    ? 'M13 2 C13 9.5 10.4 15.2 5.2 18.6 C4.1 19.3 4.4 20.3 5.7 20.1 C8.9 19.5 11.4 18 13 16 Z'
    : 'M0 2 C0 9.5 2.6 15.2 7.8 18.6 C8.9 19.3 8.6 20.3 7.3 20.1 C4.1 19.5 1.6 18 0 16 Z';
  return svgTag(13,21,'cv-tail',
