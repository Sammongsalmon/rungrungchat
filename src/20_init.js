...
/* ============================================================
   ...
   ============================================================ */
const SAMPLE_CHAT=[
'< 보낸사람 : 쿠베라 / 발신시간 : 09:14 / 받는사람 : 아모가싯디 >','',
'[ㅇ]','[ㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇ]','[ㅋㅍㅌ ㅊㄹ ㅇ ㅗ홏]','',
'< 보낸사람 : 아모가싯디 / 발신시간 : 09:15 / 받는사람 : 쿠베라 >','',
'[뭐야]','[어이. 자판 잘못 눌렀냐]','',
'< 보낸사람 : 쿠베라 / 발신시간 : 09:15 / 받는사람 : 아모가싯디 >','',
'[ㅇㅏㅃㅏ]','[😾😾😾😾😾😾]','[🍭🍭🍭]','',
'< 보낸사람 : 아모가싯디 / 발신시간 : 09:16 / 받는사람 : 쿠베라 >','',
'[………]','[여울이냐]','[엄마 폰 만지지 마라]','',
'< 보낸사람 : 쿠베라 / 발신시간 : 09:16 / 받는사람 : 아모가싯디 >','',
'[아니]','[가온]','[ㅇ ㅏㄴㅣ 여울]','[둘다]','',
'< 보낸사람 : 아모가싯디 / 발신시간 : 09:17 / 받는사람 : 쿠베라 >','',
'[둘 다 뭐야 씨]','[엄마는]','',
'< 보낸사람 : 쿠베라 / 발신시간 : 09:17 / 받는사람 : 아모가싯디 >','',
'[샤워]','[여울이가 아빠 사탕 다 먹었어]','[내가 안 먹었어 오빠가 먹었어]','[🍭❌]','',
'< 보낸사람 : 아모가싯디 / 발신시간 : 09:18 / 받는사람 : 쿠베라 >','',
'[다 먹었다고?]','[서랍 두 번째 칸 그거]','[…괜찮아 더 사면 되고]','[이 닦아라 둘 다]','',
'< 보낸사람 : 쿠베라 / 발신시간 : 09:19 / 받는사람 : 아모가싯디 >','',
'[아빠 언제 와]','[언제와]','[언제와언제와언제와언제와언제]','',
'< 보낸사람 : 아모가싯디 / 발신시간 : 09:19 / 받는사람 : 쿠베라 >','',
'[**여섯 시**]','[여섯 시에 간다]','[그때까지 엄마 말 들어]','',
'< 보낸사람 : 쿠베라 / 발신시간 : 09:20 / 받는사람 : 아모가싯디 >','',
'[여울이가 오빠 던졌어]','',
'< 보낸사람 : 아모가싯디 / 발신시간 : 09:20 / 받는사람 : 쿠베라 >','',
'[뭐]','[던졌다고?]','[야]','[**전화 받아**]','[여울이 폰 줘 봐]','',
'< 보낸사람 : 쿠베라 / 발신시간 : 09:22 / 받는사람 : 아모가싯디 >','',
'[안 아파]','[재밌었어]','[또 해도 돼?]','',
'< 보낸사람 : 아모가싯디 / 발신시간 : 09:22 / 받는사람 : 쿠베라 >','',
'[안 돼]','[사람은 던지는 거 아니야]','[…형제한테는 특히 아니야]','[알았냐]','',
'< 보낸사람 : 쿠베라 / 발신시간 : 09:23 / 받는사람 : 아모가싯디 >','',
'[알았어]','[아빠는 던졌잖아]','[엄마가 아빠 던진 얘기 해줬어]','',
'< 보낸사람 : 아모가싯디 / 발신시간 : 09:24 / 받는사람 : 쿠베라 >','',
'[…………]','[그건 엄마가 잘못했다]','[~~그건 내가 진 거 아니야~~]','[그 얘긴 나중에 하자]','',
'< 보낸사람 : 아모가싯디 / 발신시간 : 09:26 / 받는사람 : 아미타바 (본래 보내려 한 사람 : 쿠베라) >','',
'[야 애들 사탕 다 털었다]','[그 무설탕 알사탕 어디서 사냐 니가 저번에 준 거]','[**애들 이 썩는다고**]','',
'< 보낸사람 : 아미타바 / 발신시간 : 09:26 / 받는사람 : 아모가싯디 >','',
'[형아 사탕은 무슨 사탕]','[헐 애들?? 형아 애 있어???]','[여보 나한테 말도 안 하고????]','',
'< 보낸사람 : 아모가싯디 / 발신시간 : 09:27 / 받는사람 : 아미타바 >','',
'[아니]','[잘못 보냈어]','[꺼져]','',
'< 보낸사람 : 아미타바 / 발신시간 : 09:27 / 받는사람 : 아모가싯디 >','',
'[ㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋ]','[형아 나 아까 애기들 봤어 슬럼에서 가람이 누나랑 같이 있었잖아]',
'[**여울이 형아 얼굴이야 진짜 똑같아**]','[가온이는 누나 닮았고]','[형아 나 이모 시켜줘]','',
'< 보낸사람 : 아모가싯디 / 발신시간 : 09:28 / 받는사람 : 아미타바 >','',
'[너 남자잖아]','[사탕 링크나 보내]','',
'< 보낸사람 : 쿠베라 / 발신시간 : 09:31 / 받는사람 : 아모가싯디 >','',
'[아빠]','[엄마 나왔어]','[머리 물 뚝뚝]','[엄마가 폰 왜 만졌냐고]','',
'< 보낸사람 : 아모가싯디 / 발신시간 : 09:32 / 받는사람 : 쿠베라 >','',
'[내가 만지라고 했다고 해]','[아니 그건 거짓말이지]','[…솔직하게 말해라]','[혼나도 내가 같이 혼나 준다]','',
'< 보낸사람 : 쿠베라 / 발신시간 : 09:33 / 받는사람 : 아모가싯디 >','',
'[엄마가 웃었어]','',
...
const SAMPLE_MEMO=[
'< 06/02 03:41 / 제목 없음 >','**생일**','아무도 안 챙기는 거 알고 있었다','~~올해는 좀 다를 줄 알았지~~',
'아니 챙겨달라고 한 적 없다','자고 일어나면 지나가 있음','',
'< 06/02 21:07 / 제목 없음 >','**미역국**','그 사람이 끓였다','간이 안 맞았다',
'소금 어디 있냐고 물어보길래 없다고 했다','있었는데 없다고 했다','왜 그랬는지 모르겠음','~~두 그릇 먹었다~~','',
'< 09/12 14:22 / ※ 반드시 확인 >','**사야 하는 것**','- 사탕 (무설탕 / 여울이 어금니)','- 가온이 실내화 240',
'- 손난로 대용량','- ~~맥주~~','- 그 사람 검 손질용 기름. 브랜드 뭐였지','- 감기약 (**액상. 알약 안 먹는다**)','',
'< 09/12 14:29 / 추가 >','검 손질용 기름','직접 물어보면 되는데 왜 못 물어보냐 씨발','',
'< 10/03 02:16 / 제목 없음 >','잠 안 옴','옆에서 자는 소리 들으면 왜 심장이 이상하냐','이게 정상이냐고 물어볼 사람이 없다',
'악쇼브야한테 물어볼까','아니 그 개새끼한테 물어보면 평생 놀림거리다','아미타바는 더 안 된다','',
'< 10/03 02:31 / 제목 없음 >','결론: 아무한테도 안 물어본다','혼자 알고 있으면 되는 거다','~~근데 알고 싶다~~','',
'< 11/21 19:50 / 훈련 기록 >','**대련 기록**','9월 – 3승 4패','10월 – 5승 5패','11월 – 4승 6패',
'*떨어지고 있다*','~~일부러 진 거 아니다~~','~~일부러 진 것도 있다~~','져도 기분 나쁘지 않은 게 제일 이상하다','',
'< 12/04 23:58 / 제목 없음 >','**애들한테 하면 안 되는 말 목록**','- 등급 얘기','- 미달자','- 열등하다','- ~~쓸모~~ 쓸모','- 쓸모없다',
'전부 내가 들었던 말이다','입에 붙어서 나오려고 할 때가 있다','그때 혀 씹으면 된다','피 맛 나면 안 나온다','',
'< 12/04 00:12 / 제목 없음 >','가온이가 내 눈 닮았다고 좋아했다','좋아할 게 아닌데','좋아하길래 아무 말도 안 했다','',
'< 01/05 07:33 / ★★★ >','**소한**','그 사람 생일','작년에 아무것도 못 했다','올해는',
'1. 뭐가 먹고 싶은지 물어본다 (직접. 문자 아니고 직접)','2. 케이크 (딸기? 초콜릿? 모른다)','3. 배치표 확인','4. 하루 비운다','5. **말한다**','',
'< 01/05 07:35 / 제목 없음 >','5번이 제일 어렵다','',
'< 01/05 07:41 / 제목 없음 >','좋아한다고 이미 했는데','그거 말고 다른 말이 있어야 하는 거 아니냐',
'근데 그거 말고 아는 말이 없다','평생 부수는 말만 배웠으니까','',
'< 01/05 07:44 / 제목 없음 >','**그러니까**','안 부수고 있는 걸 세는 게 낫다','',
'방 하나','컵 두 개','숟가락 네 개','검 한 자루 (부순 적 있음. **이번 건 안 부순다**)','애 둘','심장 하나','',
'이게 내가 지키고 있는 거 전부다','~~적어보니까 얼마 안 되네~~','아니 많다','많다고 해야 맞다','',
'< 01/05 07:52 / 제목 없음 >','목록 마지막에 적을 말','','**한가람**','',
'< 01/05 07:53 / 제목 없음 >','쓰고 나니까 손이 떨린다','~~병신같이~~','지운다','아니 안 지운다'
].join('\n');
...
function wire(){
  ...
  on($('#btnSample'),'click',function(){
    ...
    if(S.mode==='chat' && !S.chat.dateLine) { S.chat.dateLine='2026년 9월 18일 금요일'; syncInputs(); }
    toast('예시를 불러왔습니다');
  });
